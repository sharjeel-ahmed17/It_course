    ...
    const { hours, minutes, seconds } = await inquirer.prompt([
        {
            ...
            message: "Enter hours:",
            default: 0,
            validate: (input) => input >= 0 ? true : "Please enter a valid number of hours.",
        },
        {
            name: "minutes",
            type: "number",
            ...
            default: 0,
            validate: (input) => input >= 0 ? true : "Please enter a valid number of minutes.",
        },
        {
            name: "seconds",
            type: "number",
            ...
            default: 0,
            validate: (input) => input >= 0 ? true : "Please enter a valid number of seconds.",
        },
    ]);
